      ...
      <div
        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none">
          <li class="items-center">
            <a class="text-blue-700 hover:text-yellow-600 text-xs uppercase py-3 font-bold block" href="#/dashboard"><i
          ...
          <li class="items-center">
            <a class="text-blue-700 hover:text-yellow-600 text-xs uppercase py-3 font-bold block" href="#/login"><i
