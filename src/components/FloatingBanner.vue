...
<div class="container my-24 mx-auto">
  ...
  <section class="mb-12">
    ...
    <div class="bg-blue-600 alert alert-dismissible fade show fixed top-0 right-0 left-0 z-[1030] w-full py-4 px-6 text-white md:flex justify-between items-center text-center md:text-left">
